...
# You will need the Song.mp3 file 
# You will need pygame and pygame.mixer
...
def main():
	...
	clock = pygame.time.Clock()
        ...
        if showstartscreen == TRUE:
            ...
            text_surface = font.render("NAKER", True, RED)
            ...
            text_surface = font.render("Press p to pause r to resume at any time", True, RED)
        ...
        while not snakedead:
            ...
            text_surface = font.render("SNAKER!          Score: " + str(score), True, RED)
